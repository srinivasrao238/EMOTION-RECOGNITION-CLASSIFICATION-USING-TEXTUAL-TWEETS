...
urlpatterns = [
    ...
    url(r'^Find_Emotion_Prediction_Ratio/$', serviceprovider.Find_Emotion_Prediction_Ratio, name="Find_Emotion_Prediction_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^Predict_Emotion_Details/$', serviceprovider.Predict_Emotion_Details, name="Predict_Emotion_Details"),
