...
def Find_Emotion_Prediction_Ratio(request):
    detection_ratio.objects.all().delete()
    ratio = ""
    kword = 'Happy'
    print(kword)
    obj = Emotion_prediction.objects.all().filter(Q(Emotion_Prediction=kword))
    obj1 = Emotion_prediction.objects.all()
    count = obj.count();
    count1 = obj1.count();
    ...
    kword1 = 'Un Happy'
    print(kword1)
    obj1 = Emotion_prediction.objects.all().filter(Q(Emotion_Prediction=kword1))
    obj11 = Emotion_prediction.objects.all()
    count1 = obj1.count();
    count11 = obj11.count();
    ...
    return render(request, 'SProvider/Find_Emotion_Prediction_Ratio.html', {'objs': obj})
...
def Predict_Emotion_Details(request):


    obj =Emotion_prediction.objects.all()
    return render(request, 'SProvider/Predict_Emotion_Details.html', {'list_objects': obj})
...
def Download_Trained_DataSets(request):
    ...
    for my_row in data:
        ...
        ws.write(row_num, 0, my_row.Tweet_Id, font_style)
        ws.write(row_num, 1, my_row.Tweet_Message, font_style)
        ws.write(row_num, 2, my_row.Emotion_Prediction, font_style)
    wb.save(response)
    return response
